...
const data = [
  ...
  },
  {
    ...
    description: "A spacious multi-purpose hall for events, cultural programs, and workshops.",
        ...
        {data.map((facility, index) => (
          ...
          >
            <div className="relative h-40 w-full rounded-lg overflow-hidden">
              <Image src={facility.img} alt={facility.title} layout="fill" className="object-cover" />
            </div>
