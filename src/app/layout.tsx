  ...
  return (
    <html lang="en">
      <body className={`${inter.className} bg-body-color`}>
        <Header />
        <div className="flex flex-col lg:flex-row justify-between py-10 px-20 gap-16">
...
function LeftBar(props: any) {
  ...
  return (
    <div className="border-solid w-[calc(100% - 80px)] lg:w-80 bg-blue-50 border-neutral-300 rounded-lg border-[1px] space-y-2 pb-7">
      <h1 className="rounded-t-lg p-2 text-blue-700 text-2xl text-center bg-blue-200 font-bold">{props.title}</h1>
