...
export default function Header() {
  return (
    <header
      id="header"
      className="relative flexjustify-center bg-[url(../../public/img/school_building.jpg)] bg-contain bg-fixed"
    >
      <div className="d:pt-28 flex justify-between gap-x-9 bg-black/30 bg-gradient-to-rfrom-black/30via-transparentto-transparent">
        <Image
          ...
          className="invisible"
           />
        <div className="max-lg:hidden absolute font-serif bottom-6 left-12 text-5xl/tight text-white ">
          <h1 className="">
